        ...
        "steps": [
            ...
            },
            {
                ...
                "text": (
                    ...
                    "wie das Geld auf den Tresen wandert. Unter der "
                    "Schnellwahl steht dann, was gelegt wurde: "
                    "\"2 × 20 €\".\n\n"
                    "Krumme Beträge tippst du weiterhin über das "
                    "Zahlenfeld ein. Sobald du das tust, verschwindet "
        ...
        "steps": [
            {
                ...
                "text": (
                    ...
                    "Computer\".\n\n"
                    "In der Artikelverwaltung sind die betroffenen "
                    "Schaltflächen dort ausgegraut: \"+ Neuer Artikel\", "
                    "\"Sortierung\", \"Bearbeiten\", \"Buchen\", das "
                    "Löschkreuz und \"Neu\"/\"Bearbeiten\" bei den "
                    "Kategorien. Über der Liste steht der Grund. Wer "
                    "einen Artikel öffnet, darf ihn ansehen - statt "
                    "\"Speichern\" steht dort \"Nur Ansicht\".\n\n"
                    "Bedienbar bleibt alles, was zusammengeführt werden "
                    "kann: verkaufen, Bestand korrigieren, "
                    "Bestellmengen notieren, Kassenbuch, Checklisten "
                    "und Schichten."
                ),
            ...
            {
                "heading": "Daten senden und empfangen",
                "text": (
                    "Für alles, was von einem Gerät zum anderen soll, "
                    "gibt es zwei Schaltflächen. Die Reihenfolge ist "
                    "wichtig:\n\n"
                    "1. Am EMPFANGENDEN Gerät \"Daten empfangen\". Es "
                    "wartet dann und zeigt seinen Namen und seine "
                    "Adresse.\n"
                    "2. Am sendenden Gerät \"Daten senden\". Es sucht im "
                    "WLAN und zeigt, wer wartet.\n"
                    "3. Das gewünschte Gerät antippen. Auf der "
                    "Gegenseite erscheint \"möchte Daten senden - "
                    "annehmen?\".\n"
                    "4. Erst nach dem Annehmen wird gewählt, WAS "
                    "hinübergeht. So kann man die Kasse nicht an ein "
                    "Gerät abgeben, das gar nicht bereit ist.\n"
                    "5. Am Ende meldet das empfangende Gerät zurück, was "
                    "daraus geworden ist - und beide Seiten sehen es.\n\n"
                    "Beide Geräte müssen im selben WLAN sein. Ein "
                    "Hotspot vom Telefon reicht."
                ),
                "image": "einstellungen/04_uebergabe.png",
            },
            {
                "heading": "Die drei Arten",
                "text": (
                    "Datenbank - Artikel, Preise, Rezepte und alles "
                    "Bisherige. Das andere Gerät wird damit Nebengerät: "
                    "Es darf mitverkaufen, Listen führen und Schichten "
                    "eintragen, aber keine Preise ändern. So wird ein "
                    "zweiter oder dritter Stand ausgestattet.\n\n"
                    "Kasse - das Schreibrecht selbst. Danach darf das "
                    "andere Gerät die Stammdaten ändern und dieses hier "
                    "nur noch zusehen. Wer sie bekommt, steht durch die "
                    "Verbindung schon fest - nichts abzutippen.\n\n"
                    "Buchungen - nur was dazugekommen ist: Verkäufe, "
                    "Kassenbuch, Checklisten, Schichten. Übernommen wird "
                    "davon nur, was drüben fehlt; zweimal gesendet ändert "
                    "deshalb nichts, und die Richtung ist beliebig."
                ),
            },
            {
                "heading": "Ohne WLAN: der Weg über die Datei",
                "text": (
                    "Ist kein gemeinsames Netz da, führt derselbe Dialog "
                    "über eine Datei. Beim Senden: \"Stattdessen als "
                    "Datei\" - das Programm schreibt sie und bietet "
                    "danach Bluetooth oder die Teilen-Auswahl an. Beim "
                    "Empfangen: \"Kein Netz? Datei suchen\".\n\n"
                    "Die Kasse lässt sich so nicht übergeben: Dafür muss "
                    "feststehen, wer sie bekommt, und das weiß nur eine "
                    "Verbindung.\n\n"
                    "Am Rechner sucht die Auswahl nicht nur im eigenen "
                    "Ordner, sondern auch in Downloads, auf dem Desktop "
                    "und im Bluetooth-Ordner - dort landet, was von außen "
                    "kommt. Zu jedem Eintrag steht die Herkunft dabei.\n\n"
                    "Auf dem Tablet öffnet \"Datei suchen\" die "
                    "Dateiauswahl des Geräts; dort ist auch zu finden, "
                    "was per Mail oder Bluetooth ankam."
                ),
            },
            {
