        ...
        "steps": [
            ...
            },
            {
                ...
                "text": (
                    ...
                    "Für zwei Geräte, die nebeneinander liegen, ist "
                    "Bluetooth der kürzeste Weg - ohne Kabel, Netz oder "
                    "Konto:\n\n"
                    "1. Auf dem sendenden Gerät die Datei erzeugen "
                    "(\"Gerät ausstatten\", \"Kasse übergeben\" oder "
                    "\"Buchungen bereitstellen\").\n"
                    "2. \"Per Bluetooth senden\" - das Gerät fragt, "
                    "wohin.\n"
                    "3. Am anderen Gerät die Datei annehmen. Sie landet "
                    "im Ordner \"Bluetooth\" bzw. \"Download\".\n"
                    "4. Dort \"Ausstattung einspielen\" bzw. \"Übergabe "
                    "einspielen\", dann \"Datei suchen\" und die eben "
                    "empfangene Datei wählen.\n\n"
                    "Am Rechner gibt es keinen Weg, eine Datei aus dem "
                    "Programm heraus per Bluetooth zu verschicken. Dort "
                    "öffnet der Knopf den Ordner mit der ausgewählten "
                    "Datei - weiter geht es über Rechtsklick, \"Senden "
                    "an\", \"Bluetooth-Gerät\".\n\n"
                    "Zwischen Tablet und Rechner geht das in beide "
                    "Richtungen, sofern die Geräte einmal gekoppelt "
                    "sind. Eine Eigenheit von Windows: Es nimmt eine "
                    "Datei nur an, wenn es vorher darauf wartet. Also "
                    "erst am Rechner Bluetooth-Einstellungen öffnen, "
                    "\"Dateien über Bluetooth senden oder empfangen\", "
                    "\"Dateien empfangen\" - und dann erst am Tablet "
                    "senden.\n\n"
                    "Wo die Datei landet, fragt Windows am Ende selbst. "
                    "Egal, wohin: Die Auswahl beim Einspielen sieht "
                    "neben dem eigenen Ordner auch in Downloads, auf dem "
                    "Desktop und im Bluetooth-Ordner nach und schreibt "
                    "dazu, woher jede Datei stammt. Umkopieren ist nicht "
                    "nötig."
                ),
            },
            {
